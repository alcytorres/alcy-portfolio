    ...
    <section id="about" className="about-section">
      ...
      <div className="about-content">
        <p className={`about-text ${expanded ? 'expanded' : ''}`}>
          ...
          I’ve honed my skills through my role as a developer at Medpod, a healthcare company, building personal projects, and completing a coding bootcamp at Actualize.
